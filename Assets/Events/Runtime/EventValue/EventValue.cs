...
namespace CatCode.Events
{
    public sealed class EventValue<T> : IEventValue<T>
    {
        ...
        public EventValue(T initial, NotifyMode notifyMode = NotifyMode.OnChanged, IEqualityComparer<T> comparer = null)
        {
            _value = initial;
            _notifyOnlyOnChange = notifyMode == NotifyMode.OnChanged;
